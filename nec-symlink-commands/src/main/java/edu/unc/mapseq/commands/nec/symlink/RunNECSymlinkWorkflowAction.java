...
@Command(scope = "nec-symlink", name = "run-workflow", description = "Run NEC Symlink Workflow")
public class RunNECSymlinkWorkflowAction extends AbstractAction {
    ...
    public RunNECSymlinkWorkflowAction() {
        super();
    }
