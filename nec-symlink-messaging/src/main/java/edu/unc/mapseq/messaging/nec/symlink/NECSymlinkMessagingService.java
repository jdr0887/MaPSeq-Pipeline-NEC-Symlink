...
public class NECSymlinkMessagingService {

    private final Logger logger = LoggerFactory.getLogger(NECSymlinkMessagingService.class);
    ...
    public NECSymlinkMessagingService() {
        super();
    }
    ...
    public void start() throws Exception {
        ...
        NECSymlinkMessageListener messageListener = new NECSymlinkMessageListener();
